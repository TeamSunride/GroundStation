...
serial_input = SerialLineInput("COM13", 2000000)
...
# add hosted InfluxDB instance as an output
hosted_influxdb_output = InfluxDBOutput(
    host="sunride-influxdb.duckdns.org",
    port=443,
    org_name="Sunride",
    bucket="telemetry",
    api_token="Cs0uiazCNzgsD-NAShVaDwBHk5RgGwx1LSu4OC5B1dQZyWnu0AhRPExoAvIJTBN0Jqde6B9R8YDnbZMjdEjmOg==",
...
# plug in our InfluxDBOutput to our SerialLineInput
serial_input.add_output(hosted_influxdb_output.input)
